...
(function() {
  ...
  if (typeof MakeMultiFilter !== 'function') {
    ...
    var arraysAreTheSame = function(a1, a2) {
  ...
  window.onload = function() {
    document.getElementById("p1Message").innerHTML = p1Message;
    document.getElementById("p2Message").innerHTML = p2Message;
    document.getElementById("p3Message").innerHTML = p3Message;
  };
}());
